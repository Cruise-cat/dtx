package com.cruise.dtx.tccdemo.bank1.service.impl;

import com.cruise.dtx.tccdemo.bank1.dao.AccountInfoDao;
import com.cruise.dtx.tccdemo.bank1.service.AccountInfoService;
import com.cruise.dtx.tccdemo.bank1.spring.Bank2Client;
...
public class AccountInfoServiceImpl implements AccountInfoService {
    ...
    @Hmily(confirmMethod = "commit", cancelMethod = "rollback") //只要标记@Hmily就是try方法，在注解中指定confirm、cancel两个方法的名字
    public void updateAccountBalance(String accountNo, Double amount) {
        ...
        // 扣减金额
        int num = accountInfoDao.subtractAccountBalance(accountNo, amount);
        if (num <= 0) {
            //扣减失败
